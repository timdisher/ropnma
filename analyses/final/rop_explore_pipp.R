...
momlinc_netgraph(pa_reac_int,pa_reac_int_char,"pa_reac",2,location = "./figs/final/pain scales reactivity/nma figs")
...
(pa_reac_pairwise = all_pairwise(pa_reac_direct_comp_char,pa_reac_contrast, outcome = "PIPP reactivity", location = "./figs/final/pain scales reactivity/pairwise ma"))
