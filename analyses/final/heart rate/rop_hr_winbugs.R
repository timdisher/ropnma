...
hr_reac$bugs$pa = nma_cont(hr_recov$bugs$data$wide,hr_recov$bugs$data$wb,hr_recov$bugs$data$treatments,params = params.re, model = list(model$re3,model$re3_inc),
