...
knitr::opts_knit$set(echo = FALSE,root.dir = "../..")
```

```{r, include = FALSE, echo = FALSE}
getwd()
source("./analyses/final/rop_clean.R")
source("./functions/nma_cont.R")

if(all(file.exists("./cache/pa_reac.rda","./cache/pa_recov.rda"))) lapply(c("./cache/pa_reac.rda","./cache/pa_recov.rda"), load, environment())else source("./analyses/final/pain scales/rop_pain_winbugs.R")

if(file.exists("./cache/cry_reac.rda")) load("./cache/cry_reac.rda") else source("./analyses/final/cry time/rop_analysis_cry.R")

if(all(file.exists("./cache/hr_reac.rda","./cache/hr_recov.rda"))) lapply(c("./cache/hr_reac.rda","./cache/hr_recov.rda"), load, environment())else source("./analyses/final/heart rate/rop_hr_winbugs.R")

if(file.exists("./cache/spo2_reac.rda")) load("./cache/spo2_reac.rda") else source("./analyses/final/spo2/rop_analysis_spo2.R")

if(file.exists("./cache/pa_reac.rda")) load("./cache/pa_reac.rda") else source("./analyses/final/spo2/rop_analysis_ae.R")
